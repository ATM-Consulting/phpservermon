...
class ServerController extends AbstractServerController {
	...
	protected function executeEdit() {
		...
		if(!empty($edit_server)) {
			...
			$tpl_data = array_merge($tpl_data, array(
				...
				'edit_value_save_feedback' => $edit_server['save_feedback'],
	...
	protected function executeSave() {
		...
		$clean = array(
			...
			'save_feedback' => intval(psm_POST('save_feedback', 0)),
	...
	protected function getLabels() {
		return array(
			...
			'label_last_feedback' => psm_get_lang('servers', 'last_feedback'),
			...
			'label_save_feedback' => psm_get_lang('servers', 'save_feedback'),
